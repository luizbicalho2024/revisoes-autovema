...
def authenticate(
    ...
    db.users.update_one(
        ...
        {
            "$set": {
                "last_login_at": __import__("datetime").datetime.now(
...
def render_login(
    ...
    with center:
        ...
        if submit:
            ...
            if failures >= 5:
                st.error(
                    "Muitas tentativas nesta sessão. "
